...
#--------------------------------------------------------------#
# Step 2: Fetch SC16IS7XX I2C sources
#--------------------------------------------------------------#
say "STEP2" "Fetching SC16IS7XX I2C sources"

BASE_URL="https://raw.githubusercontent.com/raspberrypi/linux/${KERNEL_BRANCH}/drivers/tty/serial"

wget -q -O "$MODULE_SRC_DIR/sc16is7xx.c"     "$BASE_URL/sc16is7xx.c"
wget -q -O "$MODULE_SRC_DIR/sc16is7xx_i2c.c" "$BASE_URL/sc16is7xx_i2c.c"
wget -q -O "$MODULE_SRC_DIR/sc16is7xx.h"     "$BASE_URL/sc16is7xx.h"
...
obj-m := sc16is7xx.o sc16is7xx_i2c.o
EOF
...
cp "$MODULE_SRC_DIR/sc16is7xx.c"      "$MODULE_BUILD_DIR/"
cp "$MODULE_SRC_DIR/sc16is7xx_i2c.c"  "$MODULE_BUILD_DIR/"
cp "$MODULE_SRC_DIR/sc16is7xx.h"      "$MODULE_BUILD_DIR/"
